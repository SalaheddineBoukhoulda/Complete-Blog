                ...
                <div class="contacts">
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">{{$settings->site_number}}</a>
                            <p class="sub-title">{{Carbon\Carbon::now()->toDateTimeString()}}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        <div class="contacts-item">
                            ...
                            <div class="content">
                                <a href="#" class="title">Oran Algeria</a>
                                <p class="sub-title">{{$settings->site_adress}}</p>
                            </div>
                        </div>
                    </div>
                </div>
