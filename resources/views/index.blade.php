                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{route('category.frontend',['slug' => $first_post->category->id])}}">{{$first_post->category->name}}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.frontend',['slug' => $second_post->category->id])}}">{{$second_post->category->name}}</a>
                                        </span>
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{route('category.frontend',['slug' => $third_post->category->id])}}">{{$third_post->category->name}}</a>
                                        </span>
            ...
            <div class="container">
                <div class="col-lg-12">
                    <div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">{{$unity->name}}</h4>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                @foreach($unity->posts()->take(3)->get() as $post)
                    ...
                    <div class="offers">
                                ...
                                <div class="row">
                                    <div class="case-item-wrap">
                                        @foreach($mysql->posts()->take(3)->get() as $post)
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="case-item">
                                                    <div class="case-item__thumb">
                                                    <img src="{{$post->featured}}" alt="{{$post->title}}">
