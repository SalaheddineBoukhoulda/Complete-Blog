                        ...
                        <div class="post__content">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                    ...
                                    <a href="{{route('category.frontend',['id' => $post->category->id])}}">{{$post->category->name}}</a>
                                </span>
                                ...
                                <div class="widget w-tags">
                                    <div class="tags-wrap">
                                        @foreach($post->tags as $tag)
                                            <a href="{{route('tag.frontend',['id' => $tag->id])}}" class="w-tags-item">{{$tag->tag}}</a>
                                        @endforeach
                        ...
                        <div  class="widget w-tags">
                            ...
                            <div class="tags-wrap text-center">
                                @foreach($all_tags as $tag)
                                    <a href="{{route('tag.frontend' , ['id' => $tag->id])}}" class="w-tags-item text-center">{{$tag->tag}}</a>
                                @endforeach
                            </div>
                        </div>
                    </aside>
